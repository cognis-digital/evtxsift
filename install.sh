#!/usr/bin/env sh
# Universal installer for evtxsift. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/evtxsift.git"
echo "Installing evtxsift ..."
