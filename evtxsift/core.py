"""EVTXSIFT core — Find brute-force, persistence & lateral-movement signals in exported Windows event logs."""
...
RULES = [
    ("EVT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("EVT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("EVT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
